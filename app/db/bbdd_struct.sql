...
/**
 * Database schema
 * Usage: mysql -u root -p < bbdd_struct.sql
 *
 * @package		SocialWebResearchAssistant
 * @subpackage  Common
...
--
CREATE DATABASE swra CHARACTER SET utf8 COLLATE utf8_general_ci;

GRANT ALL ON swra.* TO swra@localhost IDENTIFIED BY "swra";

FLUSH PRIVILEGES;


--
-- Database 'swra' structure
--
